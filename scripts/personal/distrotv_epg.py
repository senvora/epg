...
# --- Save plain XML ---
with open(xml_file, "wb") as f_xml:
    f_xml.write(pretty_xml_as_str)

# --- Save gzipped XML ---
with gzip.open(gzip_file, "wb") as f_gz:
    f_gz.write(pretty_xml_as_str)

# --- Validate gzip ---
subprocess.run(["gunzip", "-t", gzip_file], check=False)

print(f"✅ Cleaned EPG saved to {xml_file}")
print(f"✅ Gzipped EPG saved to {gzip_file}")
